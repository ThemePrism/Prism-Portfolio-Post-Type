...
function prism_gallery_regenerate_thumbnails( $attachment_ids = NULL )
{
...
add_action('wp_ajax_prism_gallery_regenerate_thumbnails', 'prism_gallery_regenerate_thumbnails');
