...
function prism_gallery_filter_terms_list_table( $class )
{
	if( PRISM_GALLERY_MEDIA_TAG_NAME == $_GET['taxonomy'] )
		$class = 'File_Gallery_Media_Tags_List_Table';
	
	return $class;
}
add_filter('get_list_table_WP_Terms_List_Table', 'prism_gallery_filter_terms_list_table');
