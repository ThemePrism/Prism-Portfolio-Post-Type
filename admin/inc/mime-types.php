 ...
 */
function prism_gallery_get_mime_type( $mimes )
{
	...
	foreach($mimes as $mime)
	{
		if( false === strpos($mime, '*') && false === strpos($mime, '/') )
		{
			...
			$mime_types = apply_filters('prism_gallery_mime_types', $mime_types);
 ...
 */
function prism_gallery_get_file_type( $mime )
{
	...
	return apply_filters('prism_gallery_get_file_type', $type, $mime);
}
