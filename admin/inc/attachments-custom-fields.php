 ...
 * @since 1.6.5
 */
function prism_gallery_add_new_attachment_custom_field()
{
...
if( false === $prism_portfolio->Gallery->acf )
	add_action('wp_ajax_add_new_attachment_custom_field', 'prism_gallery_add_new_attachment_custom_field');
 ...
 * @since 1.6.5
 */
function prism_gallery_delete_attachment_custom_field()
{
...
if( false === $prism_portfolio->Gallery->acf )
	add_action('wp_ajax_delete_attachment_custom_field', 'prism_gallery_delete_attachment_custom_field');
...
add_filter('attachment_fields_to_edit', 'prism_gallery_attachment_fields_to_edit', 10, 2);
 ...
 * @since 1.6.5
 */
function prism_gallery_attachment_fields_to_save( $attachment, $new_data )
{
	global $pagenow;
...
if( false === $prism_portfolio->Gallery->acf )
	add_filter('attachment_fields_to_save', 'prism_gallery_attachment_fields_to_save', 10, 2);
