 ...
 * @since 1.0
 */
function prism_gallery_save_menu()
{
	global $wpdb;
	...
	{
		$error = __('Database error! Function: prism_gallery_save_menu', 'file-gallery');
...
add_action('wp_ajax_prism_gallery_save_menu_order', 'prism_gallery_save_menu');
 ...
 * @since 1.5
 */
function prism_gallery_save_toggle_state()
{
	check_ajax_referer('file-gallery');
...
add_action('wp_ajax_prism_gallery_save_toggle_state', 'prism_gallery_save_toggle_state');
add_action('wp_ajax_prism_gallery_save_single_toggle_state', 'prism_gallery_save_toggle_state');
add_action('wp_ajax_prism_gallery_save_acf_toggle_state', 'prism_gallery_save_toggle_state');
